...
- Every normalized item has a stable static detail route with category, description, price, quality, named stats, signed direct damage/resistance/primary/secondary modifiers, resolved or explicitly unresolved spell triggers, source/file provenance, attached diagnostics, and known recipe relationships.
...
- Every normalized spell has a stable static detail route with mana source formulas, ordered animation/impact presentation declarations, ordered buff declarations, loss-aware buff lifecycle/stacking parameters, signed direct and sight-radius modifiers, target/player hit buff event hooks, direct effects, resolved or explicitly unresolved spell/stat targets, cycle-safe recursive effect relationships, item/spell/buff-hook/ability/monster/instability backlinks, source/file provenance, and attached diagnostics. Detailed presentation references stay hidden and source frame values do not claim timing semantics. Unsupported nested buff mechanics remain visible as diagnostics rather than fabricated behavior, and sight modifiers do not claim a final visibility formula. Resolved spell references on item, stat, encrustment, and monster pages link to these routes.
...
- Search covers item and stat records and supports shareable text, entity-type, source, item-category, and item-stat filters, including source-defined item modifiers when standalone stat definitions are unavailable.
