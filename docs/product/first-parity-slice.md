...
The inherited route-registry publication lifecycle and the first incremental
local entity-asset import for item icons are implemented. Other asset families
remain page-driven.
