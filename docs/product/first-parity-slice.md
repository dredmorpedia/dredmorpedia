...
- Every normalized item has a stable static detail route with a human-readable, source-shape-derived category, description, price, quality, loss-aware artifact quality declarations, named stats, signed direct damage/resistance/primary/secondary modifiers, resolved or explicitly unresolved spell triggers, source/file provenance, attached diagnostics, and known recipe relationships.
