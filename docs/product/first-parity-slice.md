...
- Every normalized item has a stable static detail route with a human-readable, source-shape-derived category, description, price, quality, loss-aware artifact quality declarations, direct Life/Mana recovery, wand charge, and trap activation/targeting/placement source values, named stats, signed direct damage/resistance/primary/secondary modifiers, resolved or explicitly unresolved spell triggers with exact retained source flags, source/file provenance, attached diagnostics, and known recipe relationships. Recovery timing, charge-use behavior, trap runtime behavior, and neutral source flags are not promoted into fabricated formulas.
