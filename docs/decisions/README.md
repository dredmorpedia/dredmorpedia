...
- [`0003-initial-search-artifact-and-query-strategy.md`](0003-initial-search-artifact-and-query-strategy.md) — Proposed (acceptance budgets pending): generated search documents, project-owned structured filtering, and bounded user-selected spelling suggestions before adopting a third-party index.
- [`0004-published-route-registry-lifecycle.md`](0004-published-route-registry-lifecycle.md) — Accepted (implementation follow-up required): inherited route reservations and tombstones for durably shared dataset versions.
