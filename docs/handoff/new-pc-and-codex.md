...
2. The preserved Meta view's **Required Armour by Monster** compatibility
   ...
   dependency view, beginning with its product brief and URL/shareability
   contract. See
...
- Expanded crafting/encrusting dependency views are the next recommended Phase
  5 slice; extra technical-detail presentation remains a page-specific polish
  decision.
