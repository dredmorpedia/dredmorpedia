...
- The current all-entity search work follows `47801cc` (`Add codebase and parity review record (#1)`). Use `git log` to confirm the latest live branch state.
