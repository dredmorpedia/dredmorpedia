...
Targeting-template parity now has static, searchable, accessible routes with strict grid-shape validation. The compatibility backlog counts below remain unchanged.
