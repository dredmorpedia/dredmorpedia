...
5. Continue monster parity: static core-profile routes, inheritance, spell/on-hit hooks, direct drops, and reciprocal spell/item backlinks are implemented; normalize remaining AI/behavior metadata next, then only independently verified derived-stat formulas.
