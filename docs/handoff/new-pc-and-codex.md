...
2. The preserved Meta view's **Required Armour by Monster** compatibility
   ...
   shopping-list tools are complete. The next recommended task is rich
   cross-list filtering and reusable filter views. See
...
- The crafting and separately modeled encrustment dependency/shopping-list
  tools are implemented. Rich cross-list filtering and reusable filter views
  are the next recommended Phase 5 slice. Extra technical-detail presentation
  remains a page-specific polish decision.
