...
2. The preserved Meta view's **Required Armour by Monster** compatibility
   ...
   The navigation checkpoint is complete; the next Phase 4 task is to inventory
   non-item art already referenced by implemented entity pages and select the
   first page-driven local-only asset slice. See
