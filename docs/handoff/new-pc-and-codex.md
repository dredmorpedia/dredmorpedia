...
2. The preserved Meta view's **Required Armour by Monster** compatibility
   ...
   comparison is implemented for up to three canonical items. A bounded build-
   planning model is the next recommended task. See
...
- The crafting and separately modeled encrustment dependency/shopping-list
  ...
  views, and up-to-three-item comparison are implemented. A bounded build-
  planning model is the next recommended Phase 5 slice. Extra technical-detail
  presentation remains a page-specific polish decision.
