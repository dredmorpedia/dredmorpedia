...
- The current static-browse work follows `666ae38` (`Update legacy audit with rebuild status`). Use `git log` to confirm the latest live branch state.
