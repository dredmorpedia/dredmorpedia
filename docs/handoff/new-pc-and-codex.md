...
- Item use metadata preserves Life/Mana recovery declarations, exact extra food source flags, and wand charge ranges; potion and mushroom trigger leaves are fully validated. Recovery timing, charge consumption, and flag behavior remain deliberately uninterpreted.
