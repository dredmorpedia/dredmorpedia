...
2. The preserved Meta view's **Required Armour by Monster** compatibility
   ...
   The first Phase 5 crafting dependency/shopping-list tool is complete. The
   next recommended task is its separately modeled encrustment extension. See
...
- The crafting dependency/shopping-list tool is implemented; its separately
  modeled encrustment extension is the next recommended Phase 5 slice. Extra
