...
| No build, package manifest, fixtures, tests, or CI existed | Node `24.18.0`, pnpm, strict TypeScript, formatting, lint, deterministic generation, CI, 302 unit/artifact tests, and 56 desktop/mobile Playwright tests are established. | Resolved |
| Fixed-width, all-DOM rendering was inaccessible and did not scale | Static detail routes and 100-record catalogue pages cover all nine entity kinds; the local canonical export currently produces 2,985 pages including dataset health, the Meta view, the crafting/encrustment dependency planners, and item comparison. The responsive semantic shell has keyboard flows, representative axe checks, explicit empty/error states, bounded result rendering, and focusable local table overflow where comparison requires it. | Resolved for current reference routes and first differentiating tools |
| Legacy search omitted major entity kinds and cloned rendered DOM | The separate deterministic search artifact currently contains 2,829 canonical documents, including 62 project-authored stat definitions. `/search/` exposes every kind, caps rendering at 50 results, offers bounded user-selected name/route-alias spelling suggestions after zero results, filters direct item/ability/spell/encrustment stat declarations through canonical keys, presents its category facet as bounded, alphabetized, contextual semantic groups, and combines recipes/encrustments under an inclusive exact source-skill bound; `/browse/` provides bounded static discovery and project-authored reusable filter URLs without JavaScript. ADR 0003's transfer, parse, query, relevance, and desktop/slowed-mobile browser budgets pass. | Resolved for current search and legacy stat discovery; heterogeneous amount ranking and undeclared skill eligibility are intentionally not inferred |
...
| Code, mod, official-data, and asset redistribution rights were unclear | The accepted local-only policy keeps official/generated derivatives ignored and blocks public official-content deployment. The page-driven importer now presents referenced item, skill, ability, root spell, and first-frame monster art through an ignored, exact-artifact-bound local set with complete PNG validation. Modern-project material is intended for a scoped MIT license. | Current boundary selected; license wording, excluded provenance, and public permission remain |
...
- [`item-comparison-evidence-2026-08-14.md`](item-comparison-evidence-2026-08-14.md),
...
- [`spell-buff-description-evidence-2026-07-28.md`](spell-buff-description-evidence-2026-07-28.md),
- [`spell-buff-halo-evidence-2026-07-28.md`](spell-buff-halo-evidence-2026-07-28.md),
- [`spell-ai-hint-evidence-2026-07-28.md`](spell-ai-hint-evidence-2026-07-28.md),
...
- [`icu-independent-output-ordering-evidence-2026-07-28.md`](icu-independent-output-ordering-evidence-2026-07-28.md),
- [`comparator-totality-evidence-2026-07-29.md`](comparator-totality-evidence-2026-07-29.md),
- [`asset-path-validation-evidence-2026-07-29.md`](asset-path-validation-evidence-2026-07-29.md),
- [`web-route-artifact-boundary-evidence-2026-07-29.md`](web-route-artifact-boundary-evidence-2026-07-29.md),
- [`asset-reference-artifact-boundary-evidence-2026-07-29.md`](asset-reference-artifact-boundary-evidence-2026-07-29.md),
- [`search-spelling-suggestions-evidence-2026-07-29.md`](search-spelling-suggestions-evidence-2026-07-29.md),
...
- [`spell-effect-named-buff-removal-evidence-2026-07-29.md`](spell-effect-named-buff-removal-evidence-2026-07-29.md),
- [`spell-buff-invisibility-evidence-2026-07-29.md`](spell-buff-invisibility-evidence-2026-07-29.md),
...
- [`dangling-reference-classification-2026-08-09.md`](dangling-reference-classification-2026-08-09.md),
...
- [`cross-entity-stat-search-evidence-2026-08-09.md`](cross-entity-stat-search-evidence-2026-08-09.md),
- [`spell-targeting-template-evidence-2026-08-11.md`](spell-targeting-template-evidence-2026-08-11.md),
...
- [`spell-radius-evidence-2026-08-11.md`](spell-radius-evidence-2026-08-11.md),
- [`spell-root-self-flag-evidence-2026-08-11.md`](spell-root-self-flag-evidence-2026-08-11.md), and
...
1. **Publication and licensing:** the current boundary is decided—official data
   and relevant entity assets remain local-only, ADRs 0001 and 0002 are
...
2. **Content parity:** no item, spell-child/effect, or spell-requirement
   ...
   value loss-aware. All 40 measured source-candidate melee-attack declarations
   are also recognized, and 39 active spells retain the effective true flag.
   All 71 measured source-candidate mine declarations are recognized, and 70
   active spells preserve their loss-aware mechanic, placement, and hidden
   presentation fields without coercing the measured `minePermanent` values to
   boolean.
   All 11 measured `consumeItem` declarations are recognized through the
   ...
   All three measured root `self` declarations are recognized through the
   strict binary grammar: two retain false and one retains true. The root field
