...
- [`spell-buff-invisibility-evidence-2026-07-29.md`](spell-buff-invisibility-evidence-2026-07-29.md), and
...
2. **Content parity:** the current canonical measurement has no remaining item compatibility diagnostic. It retains 42 unsupported or partially supported spell constructs, 13 spell-requirement diagnostics, and 23 dangling references. Each supported spell family still needs source/legacy evidence, strict normalization, synthetic coverage, UI disclosure, and deterministic official verification.
