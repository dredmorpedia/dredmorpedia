...
| No build, package manifest, fixtures, tests, or CI existed | Node `24.18.0`, pnpm, strict TypeScript, formatting, lint, deterministic generation, CI, 150 unit/artifact tests, and 36 desktop/mobile Playwright tests are established. | Resolved |
...
- [`spell-effect-after-flag-evidence-2026-07-29.md`](spell-effect-after-flag-evidence-2026-07-29.md), and
...
2. **Content parity:** the current canonical measurement has no remaining item compatibility diagnostic. It retains 154 unsupported or partially supported spell constructs, 13 spell-requirement diagnostics, and 23 dangling references. Each supported spell family still needs source/legacy evidence, strict normalization, synthetic coverage, UI disclosure, and deterministic official verification.
