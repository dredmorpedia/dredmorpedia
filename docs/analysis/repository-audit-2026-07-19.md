...
| No build, package manifest, fixtures, tests, or CI existed | Node `24.18.0`, pnpm, strict TypeScript, formatting, lint, deterministic generation, CI, 257 unit/artifact tests, and 38 desktop/mobile Playwright tests are established. | Resolved |
...
- [`spell-mine-declaration-evidence-2026-08-11.md`](spell-mine-declaration-evidence-2026-08-11.md), and
...
2. **Content parity:** no item, spell-child/effect, or spell-requirement
   ...
   218 unsupported attributes across six case-insensitive families for later
