...
## Modern rebuild status as of 2026-08-11
...
| No build, package manifest, fixtures, tests, or CI existed | Node `24.18.0`, pnpm, strict TypeScript, formatting, lint, deterministic generation, CI, 262 unit/artifact tests, and 38 desktop/mobile Playwright tests are established. | Resolved |
