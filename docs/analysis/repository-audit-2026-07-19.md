...
| No build, package manifest, fixtures, tests, or CI existed | Node `24.18.0`, pnpm, strict TypeScript, formatting, lint, deterministic generation, CI, 103 unit/artifact tests, and 30 desktop/mobile Playwright tests are established. | Resolved |
...
- [`item-weapon-declaration-evidence-2026-07-28.md`](item-weapon-declaration-evidence-2026-07-28.md), and
