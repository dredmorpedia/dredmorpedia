...
| No build, package manifest, fixtures, tests, or CI existed | Node `24.18.0`, pnpm, strict TypeScript, formatting, lint, deterministic generation, CI, 105 unit/artifact tests, and 32 desktop/mobile Playwright tests are established. | Resolved |
...
- [`item-macguffin-declaration-evidence-2026-07-28.md`](item-macguffin-declaration-evidence-2026-07-28.md), and
...
2. **Content parity:** the current canonical measurement retains 8 item compatibility diagnostics, all `toolkit`, 2,335 unsupported or partially supported spell constructs, 13 spell-requirement diagnostics, and 20 dangling references. Each supported family still needs source/legacy evidence, strict normalization, synthetic coverage, UI disclosure, and deterministic official verification.
