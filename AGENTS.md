...
- Generated artifacts live under gitignored `data/generated/`; dataset schema 3 separates normalized entities from search schema 1 and carries versioned source/patch provenance. The web application consumes these artifacts and must never parse raw XML.
